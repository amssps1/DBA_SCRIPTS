...
SELECT TOP (50)
    ...
    FORMAT(AtualDate, 'MMM yyyy', 'pt-PT') AS MesAno, 
    AtualMB, CrescMB
FROM Cres
-- só mostra quem realmente cresceu (opcional: comenta a próxima linha se quiseres ver quedas/empates)
WHERE CrescMB > 200 AND DatabaseName NOT IN ('OutSystems_Log2023','OutSystemsLifeTime_Log')
ORDER BY DatabaseName, CrescMB DESC